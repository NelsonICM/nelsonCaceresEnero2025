...
public class AttendanceManager {
    ...
    public AttendanceManager() {
        ...
        logger = Logger.getInstance(); // Se obtiene la unica instancia del Logger
    }
    ...
    public void markAttendance(String student, String status) {
        ...
        switch (status.toLowerCase()) {
            case "presente":
                logger.log("INFO", "Alumno " + student + " esta presente.");
                break;
            case "ausente":
                logger.log("ERROR", "Alumno " + student + " esta ausente.");
                break;
            case "justificado":
